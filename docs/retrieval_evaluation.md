...
**`elasticsearch_rrf`** (Elasticsearch's native RRF) — three metrics axes:
retrieval quality, answer relevancy, cost, and latency.
...
Easiest — builds the index, starts Elasticsearch, and opens the notebook:
